<header class="main-header">
    <a href="#" class="logo" target="_blank">
        <span class="logo-mini"><b>LVYOU</b></span>
        <span class="logo-lg"><b>高校学生社团管理系统</b></span>
    </a>
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu">
            ...
            <li class="treeview" module="cms">
                <a href="#">
                    <i class="fa fa-book"></i> <span>信息管理</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="${managePath}/cms/articleCate/list" module="cms"><i class="fa fa-circle-o"></i>信息分类管理</a></li>
                    <li><a href="${managePath}/cms/index" module="cms"><i class="fa fa-circle-o"></i>信息管理</a></li>
                </ul>
            </li>
            ...
            <li class="treeview" module="group">
                <a href="#">
                    <i class="fa fa-group"></i> <span>社团管理</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="${managePath}/group/index" module="group"><i class="fa fa-circle-o"></i>社团审核管理</a></li>
                    <li><a href="${managePath}/group/indexone" module="group"><i class="fa fa-circle-o"></i>社团比赛管理</a></li>
                    <li><a href="${managePath}/group/indextwo" module="group"><i class="fa fa-circle-o"></i>社团经费管理</a></li>
<#--                    <li><a href="${basePath}/group/" module="group"><i class="fa fa-circle-o"></i>社团活动管理</a></li>-->
                </ul>
            </li>
            <li class="treeview" module="weibo">
                <a href="#">
                    <i class="fa fa-weibo"></i> <span>社团相册管理</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="${managePath}/weibo/index" module="weibo"><i class="fa fa-circle-o"></i>相册管理</a></li>
                </ul>
            </li>
            <li class="treeview" module="picture">
                <a href="#">
                    <i class="fa fa-picture-o"></i> <span>社团图库管理</span>
                    <span class="pull-right-container"><i class="fa fa-angle-left pull-right"></i></span>
                </a>
                <ul class="treeview-menu">
                    <li><a href="${managePath}/tag/list/7" module="picture"><i class="fa fa-circle-o"></i>社团 标签管理</a></li>
                    <li><a href="${managePath}/picture/list" module="picture"><i class="fa fa-circle-o"></i>社团图片管理</a></li>
                </ul>
            </li>
