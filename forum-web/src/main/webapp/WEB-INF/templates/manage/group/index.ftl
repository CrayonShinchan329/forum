...
<#include "/manage/common/header.ftl"/>
    <div class="content-wrapper">
        <section class="content-header">
            <h1>社团管理(社团数量：${model.page.totalCount})</h1>
            <ol class="breadcrumb">
                        ...
                        <div class="box-body table-responsive no-padding">
                            <table class="table table-hover">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="marg-l-5" target="_blank" href="${managePath}/group/detail/?id=${group.id}">
                                    ...
                                    <td>
                                        <a class="marg-l-5" target="_jeesnsLink"
                                           href="${managePath}/group/delete/${group.id}" confirm="确定要删除社团吗？删除后社团信息都会被删除！">
