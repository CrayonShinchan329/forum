...
<head>
    ...
    <title>系统设置 - ${SITE_NAME} - 高校学生社团管理系统系统- </title>
        ...
        <section class="content">
            <div class="nav-tabs-custom">
                <ul class="nav nav-tabs">
                    ...
                    <li class=""><a data-toggle="tab" href="#tab-4" aria-expanded="false">问答设置</a></li>
                    <li class=""><a data-toggle="tab" href="#tab-5" aria-expanded="false">社团设置</a></li>
                </ul>
                    ...
                    <div id="tab-3" class="tab-pane">
                        <div class="panel-body">
                            <form class="form-horizontal jeesns_form" role="form" action="${managePath}/system/config/cmsUpdate" method="post">
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">社团信息投稿</label>
                                    <div class="col-sm-8">
                    ...
                    <div id="tab-4" class="tab-pane">
                        <div class="panel-body">
                            <form class="form-horizontal jeesns_form" role="form" action="${managePath}/system/config/weiboUpdate" method="post">
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">问答别名</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="weibo_alias" name="weibo_alias" placeholder="问答别名" value="${weibo_alias}">默认为问答
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">问答发布</label>
                                    <div class="col-sm-8">
                                ...
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">问答字数</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="weibo_post_maxcontent" name="weibo_post_maxcontent" placeholder="问答字数" value="${weibo_post_maxcontent}">
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-sm-offset-1 col-sm-10">
                    ...
                    <div id="tab-5" class="tab-pane">
                        <div class="panel-body">
                            <form class="form-horizontal jeesns_form" role="form" action="${managePath}/system/config/groupUpdate" method="post">
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">社团别名</label>
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" id="group_alias" name="group_alias" placeholder="社团别名" value="${group_alias}">默认为社团
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="col-sm-1 control-label">社团申请</label>
                                    <div class="col-sm-8">
