...
<head>
    ...
    <title>社团信息管理 - ${SITE_NAME} - 高校学生社团管理系统系统- </title>
...
<#include "/manage/common/header.ftl"/>
    <div class="content-wrapper">
        <section class="content-header">
            <h1>社团信息(${model.page.totalCount})</h1>
            <ol class="breadcrumb">
                <li><a href="${managePath}/index"><i class="fa fa-dashboard"></i> 主页</a></li>
                <li class="active">社团信息管理</li>
            </ol>
        </section>
                        ...
                        <div class="box-header">
                            <h3 class="box-title">
                                <a href="${managePath}/cms/article/add" target="_jeesnsOpen"
                                   title="发布社团信息" width="1000px" height="680px">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a href="${managePath}/cms/article/edit/${article.id}" target="_jeesnsOpen"
                                           title="编辑社团信息" width="1000px" height="680px">
                                            <span class="label label-warning"><i class="fa fa-edit green"></i></span>
                                        </a>
                                        <a class="marg-l-5" target="_jeesnsLink"
                                           href="${managePath}/cms/article/delete/${article.id}" confirm="确定要删除社团信息吗？">
