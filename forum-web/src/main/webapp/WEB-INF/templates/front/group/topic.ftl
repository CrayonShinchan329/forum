        ...
        <div class="row">
            <div class="col-md-8">
                            ...
                            <#if loginUser?? && (loginUser.id == groupTopic.memberId || loginUser.isAdmin &gt; 0)>
                                <div class="dropdown dropdown-hover">
                                    ...
                                    <ul class="dropdown-menu">
                                        ...
                                        <li><a href="${basePath}/group/delete/${groupTopic.id}" confirm="确定要删除活动吗？" target="_jeesnsLink">删除</a></li>
                                    </ul>
                                </div>
                            </#if>
                            </dd>
                ...
                <div class="comments panel">
                    <div class="panel-heading">活动评论</div>
                    <header>
            ...
            <div class="col-md-4">
                <a href="${basePath}/group/post/${groupTopic.group.id}" class="btn btn-block btn-lg btn-info">发布活动</a>
                    ...
                    <div class="group-detail">
                        <p>
                            ...
                            <span class="text-right">
                                ...
                                <#if isManager == 1>
                                    . <a href="${basePath}/group/auditList/${groupTopic.group.id}">审核活动</a>
                                </#if>
                            </span>
                        </p>
                    </div>
