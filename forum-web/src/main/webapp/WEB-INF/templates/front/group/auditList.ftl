...
<head>
    ...
    <title>审核活动 - ${group.name} - ${GROUP_ALIAS} - ${SITE_NAME} - </title>
                                ...
                                <div class="item-content">
                                    ...
                                    <div class="text">
                                        ...
                                        <p>
                                            ...
                                            <a href="${basePath}/group/audit/${topic.id}" class="btn-link" target="_jeesnsLink" confirm="确定审核通过该活动吗？">
                                                <span class="label label-badge label-info">审核</span>
                                            </a>
                                            <a href="${basePath}/group/delete/${topic.id}" class="btn-link" target="_jeesnsLink" confirm="确定要删除该活动吗？">
