            ...
            <div class="col-md-12 article-detail">
                <form class="form-horizontal jeesns_form" role="form" action="${basePath}/group/apply" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="count" name="count" placeholder="社团人数" data-type="require">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">社团类别</label>
                        <div class="col-sm-3">
                           <select name="type" class="form-control">
                               <option value="学术科技">学术科技</option>
                               <option value="艺术推广">艺术推广</option>
                               <option value="体育文化">体育文化</option>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <input type="text" class="form-control" id="count" name="teacher" placeholder="指导老师" data-type="require">
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">指导老师基本情况介绍</label>
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="3" name="teacherDes" alt="指导老师基本情况介绍"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">申请人基本情况介绍</label>
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="3" name="userDes" alt="申请人基本情况介绍"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">筹备申请书</label>
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="3" name="prepare" alt="申请人基本情况介绍"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
                        <label class="col-sm-1 control-label">章程草案</label>
                        <div class="col-sm-8">
                            <textarea class="form-control" rows="3" name="design" alt="申请人基本情况介绍"></textarea>
                        </div>
                    </div>
                    <div class="form-group">
