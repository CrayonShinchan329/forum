    ...
    <div id="banner" class="carousel slide" data-ride="carousel">
        ...
        <div class="carousel-inner">
            <div class="item active">
                <img alt="First slide" src="${basePath}/res/front/images/banner4.png">
            ...
            <div class="item">
                <img alt="Second slide" src="${basePath}/res/front/images/banner5.jpg">
                <div class="carousel-caption">
                    <h3></h3>
                    <p></p>
                </div>
            ...
            <div class="item">
                <img alt="Third slide" src="${basePath}/res/front/images/banner6.jpg">
                <div class="carousel-caption">
                    <h3></h3>
                    <p></p>
                </div>
            ...
            <div class="col-md-12">
                <div class="panel group-topic-list no-border">
                    ...
                    <div class="panel-body">
                        <div class="items">
                        <@cms_article_list cid=0 num=4 thumbnail=0; article>
            ...
            <div class="col-md-12">
                <div class="panel group-topic-list no-border">
                    <div class="panel-heading">
                        推荐活动
                        <span class="pull-right">
                            <a class="btn btn-primary m-t-n4" href="${basePath}/group/">更多活动</a>
                        </span>
                    </div>
                    <div class="panel-body">
                        <div class="items">
                        ...
                        <div class="items">
                            ...
                            <@group_list status=1 num=8; group>
                                <#list groupList as group>
                                    <div class="col-md-3">
                                        <div class="group-detail" style="margin:50px auto;height:150px">
